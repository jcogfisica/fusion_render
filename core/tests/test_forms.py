...
class ContactFormTestCase(TestCase):
    ...
    def setUp(self):
        # Método especial chamado antes de cada teste ser executado.
    ...
    def test_send_email(self):
        # Define um método de teste chamado `test_send_email`.
        # Todo método de teste deve começar com `test_` para ser reconhecido pelo framework.
        # Este método vai verificar se o envio de e-mail do formulário funciona corretamente.
        ...
        # Chama o método `send_email()` do formulário e armazena o resultado em `res1`.
        # Esse método deve enviar um e-mail (de acordo com a implementação no forms.py)
        ...
        # Chama o método `send_email()` para enviar o e-mail usando a segunda instância.
        ...
        # independentemente da instância usada para chamar o método.
